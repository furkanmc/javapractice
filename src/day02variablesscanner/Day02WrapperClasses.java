...
public class Day02WrapperClasses {
	/*
	 Wrapper Class: Non-primitive classses have many useful methods but primitive classes do not.
	...
	System.out.println(b2.MIN_VALUE);//-127
	...
	System.out.println(s2.compareTo(s3));// compareTo() method returns 0, if the numbers are equal to each other
										 // s2.compareTo(s3) methods returned -2 for 123 and 125 it means s2 - s3
	Integer i1 = 1234;
	...
	Double d1= 23.345;
	System.out.println(d1.MIN_VALUE);//1.7976931348623157E308
	}
